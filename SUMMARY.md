...
- [Pósthólfið](handbook/technical-overview/postholf/README.md)
  - [Security Checklist](handbook/technical-overview/postholf/postholf-00-security-checklist.md)
...
- [Application](libs/application/README.md)
  - [API](libs/application/api/README.md)
    ...
    - [Application API History](libs/application/api/history/README.md)
...
- [Auth](libs/auth/README.md)
  ...
  - [Auth Shared](libs/auth/shared/README.md)
...
- [Clients](libs/clients/README.md)
  ...
  - [Auth](libs/clients/auth/README.md)
    ...
    - [IDS API](libs/clients/auth/ids-api/README.md)
    - [Public API](libs/clients/auth/public-api/README.md)
  - [Ark](libs/clients/charge-fjs-v2/README.md)
  - [Consultation Portal](libs/clients/consultation-portal/README.md)
